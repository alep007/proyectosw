...
@WebServiceClient(name = "SearchService",
                  wsdlLocation = "http://localhost:9090/lastrest-webservice/services/SearchService?wsdl",
                  targetNamespace = "http://service.lastrest.andromda.sw.org/")
public class SearchServiceSEIClient extends Service
{
    ...
    public static final QName SERVICE = new QName("http://service.lastrest.andromda.sw.org/", "SearchService");
    /** Endpoint Service QName @see {@link javax.xml.namespace.QName} */
    public static final QName SearchService = new QName("http://service.lastrest.andromda.sw.org/", "SearchService");
    static
    {
        URL url = null;
        try
        {
            url = new URL("http://localhost:9090/lastrest-webservice/services/SearchService?wsdl");
        }
        catch (MalformedURLException e)
        {
            LOG.error("Can not initialize the default wsdl from http://localhost:9090/lastrest-webservice/services/SearchService?wsdl", e);
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
