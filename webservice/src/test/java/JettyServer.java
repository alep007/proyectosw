...
/* Autogenerated on 04/28/2016 00:53:42-0400 by AndroMDA, can be edited
 *
...
public class JettyServer
{
    ...
    protected JettyServer() throws Exception
    {
        ...
        webappcontext.setContextPath("/lastrest-webservice");
        ...
        server.start();
        System.out.println("Jetty Server running on port 9090 under context lastrest-webservice...");
        server.join();
    }
