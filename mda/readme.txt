    ...
    The project located in this directory has been generated by alejandro cabrera
    ...
    that a model called 'lastrest' has been created within your Magic Draw model.

    Important: before launching AndroMDA, be sure to have exported your model.

    /lastrest J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/alejandro cabrera/.m2/repository/lastrest/
